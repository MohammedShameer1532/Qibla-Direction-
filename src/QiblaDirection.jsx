...
const QiblaDirection = ({ latitude, longitude }) => {
  ...
  const [deviceOrientation, setDeviceOrientation] = useState(0); // Current device orientation
        ...
        <div>
          ...
          <div
            style={{
              ...
              position: "relative",
              transform: `rotate(${direction - deviceOrientation}deg)`, // Rotate based on device orientation
            }}
          >
